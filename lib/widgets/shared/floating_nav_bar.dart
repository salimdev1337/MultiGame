...
class _FloatingNavBarState extends State<FloatingNavBar>
  ...
  // Cached screen width to avoid MediaQuery calls inside AnimatedBuilder (60 FPS)
          ...
          child: ClipRRect(
            ...
            child: BackdropFilter(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: DSColors
                      .surface, // Solid fallback for devices without BackdropFilter
                      ...
                      children: [
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            ...
                            final endPos = _calculatePosition(
                              widget.currentIndex,
                            );
                            final currentPos =
                        ...
                        // Navigation items — RepaintBoundary isolates them from
                        // the AnimatedBuilder's 60 FPS indicator repaints
                        RepaintBoundary(
                          child: Row(
  ...
  double _calculatePosition(int index) {
    ...
    final spacing =
        (_screenWidth - (DSSpacing.md * 2) - (DSSpacing.sm * 2)) /
        widget.items.length;
    return (spacing * index) + (spacing - itemWidth) / 2;
  }

  double _getItemWidth() {
    final totalWidth = _screenWidth - (DSSpacing.md * 2) - (DSSpacing.sm * 2);
