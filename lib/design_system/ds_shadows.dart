...
class DSShadows {
  ...
  // Pre-calculated ARGB hex colors for shadows (avoids runtime allocations)
  // Format: 0xAARRGGBB — black (0x000000) with given alpha (0-255)
  static const _black05 = Color(0x0D000000); // 5%
  static const _black08 = Color(0x14000000); // 8%
  static const _black10 = Color(0x1A000000); // 10%
  static const _black15 = Color(0x26000000); // 15%
  static const _black20 = Color(0x33000000); // 20%
  static const _black25 = Color(0x40000000); // 25%
  static const _black30 = Color(0x4D000000); // 30%

  /// Subtle shadow - Level 1
  static const List<BoxShadow> shadowSm = [
    BoxShadow(color: _black05, blurRadius: 4, offset: Offset(0, 1)),
  ];

  /// Standard shadow - Level 2
  static const List<BoxShadow> shadowMd = [
    BoxShadow(color: _black10, blurRadius: 8, offset: Offset(0, 2)),
    BoxShadow(color: _black05, blurRadius: 4, offset: Offset(0, 1)),
  ];

  /// Pronounced shadow - Level 3
  static const List<BoxShadow> shadowLg = [
    BoxShadow(color: _black15, blurRadius: 12, offset: Offset(0, 4)),
    BoxShadow(color: _black08, blurRadius: 6, offset: Offset(0, 2)),
  ];

  /// Large shadow - Level 4
  static const List<BoxShadow> shadowXl = [
    BoxShadow(color: _black20, blurRadius: 20, offset: Offset(0, 8)),
    BoxShadow(color: _black10, blurRadius: 10, offset: Offset(0, 4)),
  ];

  /// Huge shadow - Level 6
  static const List<BoxShadow> shadowXxl = [
    BoxShadow(color: _black25, blurRadius: 30, offset: Offset(0, 12)),
    BoxShadow(color: _black15, blurRadius: 15, offset: Offset(0, 6)),
  ];

  /// Massive shadow - Level 8
  static const List<BoxShadow> shadowXxxl = [
    BoxShadow(color: _black30, blurRadius: 40, offset: Offset(0, 16)),
    BoxShadow(color: _black20, blurRadius: 20, offset: Offset(0, 8)),
  ];
