...
class BombMessage {
  ...
  static BombMessage joined(int playerId, String displayName) =>
      BombMessage(BombMessageType.joined, {
        'id': playerId,
        'name': displayName,
      });
  ...
  static BombMessage move(int playerId, double dx, double dy) =>
      BombMessage(BombMessageType.move, {
        'id': playerId,
        'dx': dx,
        'dy': dy,
      });
  ...
  static BombMessage bombPlaced(int bombId, int x, int y, int ownerId, int range) =>
  ...
  static BombMessage explosion(List<Map<String, int>> tiles, List<Map<String, int>> destroyed) =>
  ...
  static BombMessage powerupSpawned(int x, int y, String type) =>
      BombMessage(BombMessageType.powerupSpawned, {'x': x, 'y': y, 'type': type});

  static BombMessage powerupTaken(int playerId, int x, int y) =>
      BombMessage(BombMessageType.powerupTaken, {'id': playerId, 'x': x, 'y': y});

  static BombMessage roundOver(int? winnerId, List<int> wins) =>
      BombMessage(BombMessageType.roundOver, {
        'winner': winnerId,
        'wins': wins,
      });
  ...
  static BombMessage rematchStart() => const BombMessage(BombMessageType.rematchStart);
